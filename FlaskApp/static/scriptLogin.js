...
function linguaItaliana()
{
    ...
    $("#passwordDimenticata").text("Password dimenticata");
    $("#registrati").text("Non sei registrato? clicca qui");
...
function linguaInglese()
{
    ...
    $("#passwordDimenticata").text("Forgot password?");
    $("#registrati").text("Not a member?, Sign Up here");
