...
function linguaItaliana()
{
    ...
    $('#azienda').text("Aggiungi Studio Commecialista");
    $('#PreferitiTitolo').text("Preferiti");
    ...
    $('#popupTesto').text('Sicuro di rimuovere questo Studio dai Preferiti?');
    $('#siButton').text('Si');
    $('#popupTesto2').text('Studio commercialista rimosso dai preferiti');
}
...
function linguaInglese()
{
    ...
    $('#azienda').text("Add Accounting Firm");
    $('#PreferitiTitolo').text("Favorities");
    ...
    $('#popupTesto').text('Are you sure to remove this Study from Favorites?');
    $('#siButton').text('Yes');
    $('#popupTesto2').text('Accounting firm removed from favorites');
}
