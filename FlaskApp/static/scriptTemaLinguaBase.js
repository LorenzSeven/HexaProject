...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    document.querySelector('.lingua #italianLanguage').addEventListener('click', function (event) {
        cambiaTestoDropdown('it');
        // event.preventDefault();
    });

    document.querySelector('.lingua #englishLanguage').addEventListener('click', function (event) {
