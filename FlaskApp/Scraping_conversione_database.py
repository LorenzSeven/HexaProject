import bs4, requests, os, csv, json, sqlite3
...
for i in range(len(Lista_link_pagina)):
    ...
    nomeFile = 'File_csv_json_database/elenco_studi_commercialisti_Lombardia_pagine_gialle_preferiti'          #nome del file che conterrà i dati
...
csv_to_json('File_csv_json_database/elenco_studi_commercialisti_Lombardia_pagine_gialle_preferiti.csv', 'File_csv_json_database/elenco_studi_commercialisti_Lombardia_pagine_gialle_preferiti.json')

#-------------------------------------Creazione e inserimento dei dati nel database-----------------------------

def insert_json_to_table(json_file, table_name):
    with open(json_file, 'r') as file:
        data = json.load(file)
    
    conn = sqlite3.connect('File_csv_json_database/databasePreferiti.sqlite')
    cursor = conn.cursor()
...
insert_json_to_table('File_csv_json_database/elenco_studi_commercialisti_Lombardia_pagine_gialle_preferiti.json', 'studi_com')
